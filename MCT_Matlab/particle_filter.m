...
%% plotting
subplot(4,1,1);
plot(1:N,x_post(:,1), "m.", 'LineWidth', 1);
xlabel("steps");
ylabel("height");
title("Plot of X1");

subplot(4,1,2);
plot(1:N,x_post(:,2), "r.", 'LineWidth', 1);
xlabel("steps");
ylabel("height");
title("Plot of X2");

subplot(4,1,3);
plot(1:N,x_post(:,3), "b.", 'LineWidth', 1);
xlabel("steps");
ylabel("height");
title("Plot of X3");

subplot(4,1,4);
plot(1:N,x_post(:,4), "g.", 'LineWidth', 1);
xlabel("steps");
ylabel("height");
title("Plot of X4");
sgtitle("Posterior X plot",fontsize=10)
print('XpostGraph','-dpng');
