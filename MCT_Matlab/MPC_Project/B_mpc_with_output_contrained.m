...
Ymin= [12; 12]; % since our lower output limit is 12, we have to fix initial value in between.
Ymax= [13.9; 14];
%=========================End========================================
...
for kk=1:N_sim
    ...
    f = -(Phi')*(Rs-F*Xf); 
    [M, gamma] = B_All_Constraints(Phi, Umin, Umax, DUmin, DUmax, Ymin, Ymax, F, ukprev, xprev, Nc, Np);
...
titl = sprintf('Case %d with output constraints' , sysType);
sgtitle(titl) 
